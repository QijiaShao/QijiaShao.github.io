...
* [12/2023] My internship work at Samsung Research on contactless SpO2 estimation across users is accepted at [ICASSP 2024](https://2024.ieeeicassp.org/) as oral presentation! We proposed a simple yet effective algorithm to handle the cross-user variation (e.g., different skin tones and ages). The proposed algorithm is also now being deployed to Samsung products!
