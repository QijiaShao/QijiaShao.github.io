...
I am passionate about solving exciting and impactful real-world challenges. My research primarily focuses on **lowering the barriers to accessing various signals**, from physical signals (e.g., force, velocity) to physiological signals (e.g., ECG, EMG, impedance) and enable applications on health, education and interaction.
